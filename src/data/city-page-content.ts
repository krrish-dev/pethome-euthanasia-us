...
export const priorityCities: CityPageContent[] = [
  ...
  },
  {
    ...
    sections: [
      { heading: 'Local appointment planning', body: 'Rancho Cucamonga is a central Inland Empire service area, so scheduling may coordinate with nearby Upland, Ontario, and Fontana routes. Calling early helps confirm timing, aftercare preferences, and whether a same-day appointment is possible.' },
  ...
  },
  {
    ...
    sections: [
      { heading: 'Riverside local service context', body: 'Riverside appointments may be coordinated with nearby Inland Empire routes, including Moreno Valley, Corona, and San Bernardino. Traffic, distance, aftercare needs, and doctor availability can affect the schedule, so direct phone confirmation is best.' },
